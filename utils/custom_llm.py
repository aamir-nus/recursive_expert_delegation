...
class CustomLLMBuilder:
    ...
    def __init__(self,
        ...
        tensor_parallel_size = tensor_parallel_size-1 if tensor_parallel_size%2 !=0 else tensor_parallel_size #tensor parallel size has to be a factor of num(attn_heads)
